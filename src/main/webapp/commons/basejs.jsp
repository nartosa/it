...
<script src="https://cdn.bootcss.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
<link rel="stylesheet" type="text/css" href="${staticPath }/static/style/css/index.css" />
<link rel="stylesheet" type="text/css" href="${staticPath }/static/style/css/globle.css" />
<%-- [扩展样式] --%>
